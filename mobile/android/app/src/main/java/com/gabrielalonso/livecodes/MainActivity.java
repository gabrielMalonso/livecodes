package com.gabrielalonso.livecodes;
...
public class MainActivity extends BridgeActivity {
    ...
    private void publishKeyboardState(boolean force) {
        ...
        // Cache for editors created after the event; no bridge to untrusted result frames.
        webView.evaluateJavascript(
            "window.livecodesKeyboardVisible=" + visible + ";" +
            "window.dispatchEvent(new CustomEvent('livecodes-keyboard',{detail:" + visible + "}));",
            null
        );
    }
